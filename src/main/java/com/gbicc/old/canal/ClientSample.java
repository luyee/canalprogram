...
public class ClientSample {
    private static final Logger log= LoggerFactory.getLogger(ClientSample.class);
	private static RowChange rowChange; 
    public static ResourceBundle rb = ResourceBundle.getBundle("config2");
    ...
    */
    public static void start(){
        ...
        String filter="cgidb.prpcmain,cgidb.prpcmainloan,cgidb.prplcompensate,cgidb.prplloss";
        ...
        try {  
            connector.connect();  
//            connector.subscribe("test.p,test.p1");
